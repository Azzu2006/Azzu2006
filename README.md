Hi, I’m SHAIK ABDUL AZIZ

Computer Science Engineering Student

Vishnu Institute of Technology | DSA Enthusiast

<img src="https://readme-typing-svg.herokuapp.com?lines=Computer+Science+Engineering+Student;Python+%7C+JavaScript+%7C+Web+Development;Hackathon+Enthusiast+%26+Problem+Solver;Learning+DSA+%26+Full+Stack+Development&font=Fira%20Code&center=true&color=00F7FF&width=600&height=50"/>
...
* Tech: Python, JavaScript, HTML, CSS, Git
* Collaborated with a team to develop innovative software solutions.
* Gained hands-on experience in project planning, coding, debugging, and presentations.

💡 24-Hour Hackathons

* Tech: Python, JavaScript, Git
* Built applications under strict deadlines using teamwork and rapid development.
* Selected among the Top 50 teams in college-level hackathon competitions.
...
* Basics of AI/ML — Infosys Springboard
...
* 🏆 Selected among the Top 50 teams in college-level hackathon competitions.
* 💡 Participated in multiple 24-hour Hackathons and Smart India Hackathon (SIH), demonstrating teamwork, problem-solving, and rapid application development skills.
